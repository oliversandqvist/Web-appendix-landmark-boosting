...
X4 <- rep(0,nsim) #not used for fitting, only for simulation
...
saveRDS(coxNaiveModels, file = "Results/coxNaiveModels_nonlinear.rds")
...
saveRDS(coxStackModels, file = "Results/coxStackModels_nonlinear.rds")
...
saveRDS(xgbNaiveModels, file = "Results/xgbNaiveModels_nonlinear.rds")
...
saveRDS(xgbStackModels, file = "Results/xgbStackModels_nonlinear.rds")
