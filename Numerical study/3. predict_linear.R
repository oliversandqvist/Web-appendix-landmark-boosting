...
dataSurv <- readRDS("Results/dataSurv_linear.rds")

tstop <- 1
h <- 1/100

coxNaive <- readRDS("Results/coxNaiveModels_linear.rds")
coxStack <- readRDS("Results/coxStackModels_linear.rds")
xgbNaive <- readRDS("Results/xgbNaiveModels_linear.rds")
xgbStack <- readRDS("Results/xgbStackModels_linear.rds")
...
saveRDS(dataSurvPred, file = "Results/dataSurvPred_linear.rds")
